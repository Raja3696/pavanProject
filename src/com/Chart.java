...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(Simulation.total,"# No Of Users","# No Of Users");
	localDefaultCategoryDataset.addValue(Simulation.similar,"# No Of Similar Users","# No Of Similar Users");
...
public void windowClosing(WindowEvent we){
  ...
  {
    JFreeChart localJFreeChart = ChartFactory.createBarChart(title, "User Type", "Count", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
